          ...
          <div className="p-8">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
                ...
                <div className="flex flex-wrap md:flex-nowrap items-center mt-3 gap-3 md:gap-6">
                  <span className={`px-4 py-2 rounded-full text-xs sm:text-sm font-semibold capitalize ${getDifficultyColor(module.difficulty)}`}>
                    {module.difficulty}
                  </span>
                  <div className="flex items-center text-xs sm:text-sm text-gray-600 bg-gray-100 px-3 py-1 rounded-full whitespace-nowrap">
                ...
                <p className="text-gray-600 max-w-3xl mt-4 text-sm sm:text-base leading-relaxed">{module.description}</p>
              </div>
        ...
        <div className="bg-gray-50 rounded-xl p-6 mb-4">
          ...
          <div className="bg-white rounded-lg shadow mb-8">
            <div className="border-b border-gray-200">
              <nav className="flex flex-nowrap md:justify-center overflow-x-auto px-4 md:px-6 scrollbar-hide">
                {[
                  ...
                  <button
                    ...
                    className={`py-4 px-3 sm:px-6 border-b-2 font-medium text-sm flex items-center gap-1.5 flex-shrink-0 whitespace-nowrap ${activeTab === tab.id
